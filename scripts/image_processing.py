...
def image_processing(image, input_image_filename):
    ...
    json_path = os.path.join('C://FYP//invision-backend//public//spaceData', f"{os.path.splitext(input_image_filename)[0]}_room_data.json")
...
if __name__ == "__main__":
    try:
        ...
        input_image_path = os.path.join('C://FYP//invision-backend//public//uploadedImages', input_image_filename)
        ...
        output_path = os.path.join('C://FYP//invision-backend//public//processedImages', output_filename)
